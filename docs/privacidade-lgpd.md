...
Transparência (CGU) segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Portal da Transparência (CGU)** | BR | dados públicos de sanções e PEP do Governo Federal |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [transparencia@mcp.ai](mailto:transparencia@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
